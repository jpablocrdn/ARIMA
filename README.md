...
<h3>Data Preparation</h3>
    ...
    <img src="Imagen1.png" style="width:80%; max-width:800px; border:1px solid #ddd; padding:10px;">
...
<h3>Verification of Stationarity </h3>
    ...
    <img src="Imagen2.png" style="width:80%; max-width:800px; border:1px solid #ddd; padding:10px;">
...
<h3>Identification of ARIMA Parameters </h3>
  ...
  <h3>Model Adjustment </h3>
      ...
      <img src="Imagen3.png" style="width:50%; max-width:800px; border:1px solid #ddd; padding:10px;">
      <img src="Imagen4.png" style="width:50%; max-width:800px; border:1px solid #ddd; padding:10px;">
  ...
  <h3>Model Evaluation </h3>
      ...
      <img src="Imagen5.png" style="width:80%; max-width:800px; border:1px solid #ddd; padding:10px;">
  ...
  <h3>Future Forecast </h3>
      ...
      <img src="Imagen6.png" style="width:80%; max-width:800px; border:1px solid #ddd; padding:10px;">
  ...
  <h3>Series Decomposition </h3>
      ...
      <img src="Imagen7.png" style="width:50%; max-width:800px; border:1px solid #ddd; padding:10px;">
